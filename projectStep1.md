...
.syntax--source.syntax--python .syntax--variable.syntax--parameter {
  ...
  <body class='markdown-preview' data-use-github-style><h1 id="project-proposals">Project Proposals</h1>
<h6 id="author-michael-eller">Author: Michael Eller</h6>
<h6 id="date-12-august-2018">Date: 12 August 2018</h6>
<p>Project ideas for software programs are endless in our computerized
...
app, and a food journal.</p>
<p>To start with, classified apps have been the key to unload unwanted
...
have a vested interest in the transaction.</p>
<p>Secondly, we all remember bulletin boards in school with announcements, 
...
environment.</p>
<p>Finally,  the dietary family of programs/ apps have been an area where shotty
...
necessity.</p>
<p>In conclusion, we love automation, information, and social media seems to run 
...
simple and providing the owner an intuitive experience is my goal.</p></body>
</html>
